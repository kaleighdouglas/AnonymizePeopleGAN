...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--pool_size_image', type=int, default=0, help='the size of image buffer that stores previously generated images')
        parser.add_argument('--pool_size_person', type=int, default=0, help='the size of image buffer that stores previously generated cropped people')
        ...
        parser.add_argument('--clip_value', type=float, default=100, help='maximum allowed value of the gradients')
