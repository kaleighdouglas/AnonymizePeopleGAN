...
class BaseModel(ABC):
    ...
    def get_current_accuracies(self):     #### CHECK - how this works - float(getattr(self, name))
        """Return traning accuracies. train.py will print out these errors on console, and save them to a file"""
        acc_ret = OrderedDict()
        ...
        for name in self.model_names:
            if isinstance(name, str):
                try:
                    ...
                    print('-- ALERT: model not loaded:', name)
