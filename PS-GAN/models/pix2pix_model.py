...
class Pix2PixModel(BaseModel):
    ...
    def get_current_errors(self):
        # try:
        #     print('self.loss_G_GAN_image', self.loss_G_GAN_image)   ## ADDED
        # except:
        #     print('loss_G_GAN_image print failed')
        # try:
        #     print('self.loss_G_GAN_image.data', self.loss_G_GAN_image.data)   ## ADDED
        # except:
        #     print('self.loss_G_GAN_image.data print failed')
        # try:
        #     print('self.loss_G_GAN_image.item', self.loss_G_GAN_image.item())   ## ADDED
        # except:
        #     print('self.loss_G_GAN_image.item() print failed')
        return OrderedDict([('G_GAN_image', self.loss_G_GAN_image.item()),
                            ('G_GAN_person', self.loss_G_GAN_person.item()),
                            ('G_L1', self.loss_G_L1.item()),
                            #('G_L1_person', self.loss_G_L1_person.item()),
    ...
    def get_current_visuals(self):
        ...
        #print(display.shape)
        # print('D2_fake', D2_fake.shape)
        # print('y,x,w,h', y,x,w,h)
        # print('display', display.shape)
        display[y[0]:h[0],x[0]:w[0],:] = D2_fake
        # print('d2fake in display', display[y[0]:h[0],x[0]:w[0],:].shape)
        # print('yhxw', y[0],h[0],x[0],w[0])
